...
def run_agent(pod_name, namespace):
    ...
    #     '{"owner":"stefan-bergstein","repo":"etx-agentic-ai",'
    ...
    try:
        ...
        fallback_prompt = (
            ...
            "Then create a Github issue with owner 'stefan-bergstein', repo 'etx-agentic-ai', "
